...
- [x] **소셜 로그인**
  - [x] Google OAuth 완전 구현
  - [ ] Kakao/Naver OAuth (Phase 2에서 필요시 추가 예정)
...
##### Phase 7: 테스트 및 검증
- [ ] **전체 플로우 테스트**
  - [ ] Google 소셜 로그인 플로우 (Step 1 → 2 → 3 → /home)
  - [ ] 뒤로가기/앞으로가기 네비게이션

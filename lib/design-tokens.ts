...
export const createButtonStyle = (variant: 'primary' | 'secondary' | 'ghost' | 'outline' | 'default' = 'primary') => {
  const base = 'inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#693BF2] disabled:opacity-50 disabled:pointer-events-none';

  const variants = {
    primary: 'bg-[#693BF2] text-white hover:bg-[#5A2FD9]',
    secondary: 'bg-transparent text-[#293341] border border-[#E0E5EB] hover:bg-[#F6F7F9]',
    ghost: 'bg-transparent text-[#693BF2] hover:bg-[#F1EEFF]',
    outline: 'bg-transparent text-[#693BF2] border border-[#693BF2] hover:bg-[#F1EEFF]',
    default: 'bg-[#693BF2] text-white hover:bg-[#5A2FD9]'
  };
